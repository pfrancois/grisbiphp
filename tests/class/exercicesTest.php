<?php
// $Id: exercicesTest.php 33 2010-08-22 22:54:52Z pfrancois $
require_once 'PHPUnit/Framework.php';
require_once 'G:\zmws\_web.zmwsc\comptes\class\loader.php';
/**
 * Test class for exercices.
 * Generated by PHPUnit on 2010-08-17 at 21:08:16.
 */
class exercicesTest extends PHPUnit_Framework_TestCase
{
	/**
	 * @var exercices
	 */
	...
	public function testGet_by_id()	{
		$r=$this->object->get_by_id(5);
		$this->assertType('exercice',$r);
		$this->assertEquals(5,$r->get_id());
	}
	/**
