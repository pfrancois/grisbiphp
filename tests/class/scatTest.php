<?php
// $Id: scatTest.php 45 2010-09-20 03:12:17Z pfrancois $
 ...
 */
class scatTest extends PHPUnit_Framework_TestCase{
	/**
	 * @var scat
	 */
	protected $object;
	...
	protected function setUp() {
		...
		$gsb_xml->reload();
		$this->object=$gsb_categories->get_by_id(6)->get_sub_by_id(1);
	}
	...
	public function testGet_nom() {
		$this->assertEquals("Bar", $this->object->get_nom());
	}
	...
	public function test_tostring(){
		$this->assertEquals("scat #1 'Bar' de la categorie #6 'Alimentation'",(string)$this->object);
	}
}
